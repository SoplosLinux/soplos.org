/**
 * Gestión de sitios frecuentes para SlopOS Linux Startpage
 */
...
class FrequentSites {
  constructor() {
    ...
    // Idioma actual
    this.currentLang = localStorage.getItem('sloposStartPageLang') || 'es';
  ...
  loadSites() {
    const savedSites = localStorage.getItem('sloposFrequentSites');
  ...
  saveSites() {
    try {
      localStorage.setItem('sloposFrequentSites', JSON.stringify(this.sites));
