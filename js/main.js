...
document.addEventListener('DOMContentLoaded', function () {
    ...
    new SoplosUI.SoplosCarousel('#requirements .requirements-cards', '.requirements-card', {
    ...
    const galleryImages = {
        tyron: [
            ...
            { src: 'images/Tyron/tyron/002-Plymouth.png', captionKey: 'plymouthCaption' },
            { src: 'images/Tyron/tyron/003-Greeter.png', captionKey: 'greeterCaption' },
            { src: 'images/Tyron/tyron/004-Desktop-01.png', captionKey: 'desktopCaption' },
            { src: 'images/Tyron/tyron/005-Desktop-02.png', captionKey: 'desktop2Caption' },
            { src: 'images/Tyron/tyron/006-Welcome-Live.png', captionKey: 'livedesktopCaption' },
            { src: 'images/Tyron/tyron/007-Calamares-01.png', captionKey: 'calamares1Caption' },
            { src: 'images/Tyron/tyron/008-calamares-02.png', captionKey: 'calamares2Caption' }
        ],
        tyson: [
            { src: 'images/Tyson/tyson/001-grub.png', captionKey: 'grubCaption' },
            { src: 'images/Tyson/tyson/002-plymouth.png', captionKey: 'plymouthCaption' },
            { src: 'images/Tyson/tyson/003-greeter.png', captionKey: 'greeterCaption' },
            { src: 'images/Tyson/tyson/004-welcome.png', captionKey: 'welcomeCaption' },
            { src: 'images/Tyson/tyson/005-desktop-01.png', captionKey: 'desktopCaption' },
            { src: 'images/Tyson/tyson/006-desktop-02.png', captionKey: 'desktop2Caption' },
            { src: 'images/Tyson/tyson/007-welcome-live.png', captionKey: 'livedesktopCaption' },
            { src: 'images/Tyson/tyson/008-calamares-01.png', captionKey: 'calamares1Caption' },
            { src: 'images/Tyson/tyson/009-calamares-02.png', captionKey: 'calamares2Caption' }
        ],
        boro: [
            { src: 'images/boro/boro/001-grub.png', captionKey: 'grubCaption' },
            { src: 'images/boro/boro/002-plymouth.png', captionKey: 'plymouthCaption' },
            ...
            { src: 'images/boro/boro/005-calamares-01.png', captionKey: 'calamares1Caption' },
            { src: 'images/boro/boro/006-calamares-02.png', captionKey: 'calamares2Caption' }
        ]
    };
    ...
    const appData = {
        tyron: {
            ...
            "repo-selector": {
                ...
                images: [
                    ...
                    'images/Tyron/repo-selector/002-gpg-keys.png',
                    'images/Tyron/repo-selector/003-speed-test.png',
                    'images/Tyron/repo-selector/004-info.png'
                ]
            },
            "welcome": {
                ...
                images: [
                    ...
                    'images/Tyron/welcome/007-recomendations.png',
                    'images/Tyron/welcome/008-customization.png'
                ]
            },
            "welcome-live": {
        ...
        tyson: {
            ...
            "repo-selector": {
                ...
                descKey: 'appRepoSelectorDesc',
                images: [
                    'images/Tyson/repo-selector/001-repo-selector.png',
                    'images/Tyson/repo-selector/002-gpg-keys.png',
                    'images/Tyson/repo-selector/003-speed-test.png',
                    'images/Tyson/repo-selector/004-info.png'
                ]
            },
            "welcome": {
                titleKey: 'appWelcomeTitle',
                descKey: 'appWelcomeDesc',
                images: [
                    'images/Tyson/welcome/001-soplos-welcome.png',
                    'images/Tyson/welcome/002-software-tab.png',
                    'images/Tyson/welcome/003-drivers-tab-01.png',
                    'images/Tyson/welcome/004-drivers-tab-02.png',
                    'images/Tyson/welcome/005-drives-tab-02.png',
                    'images/Tyson/welcome/006-kernels-tab.png',
                    'images/Tyson/welcome/007-recommends-tab.png',
                    'images/Tyson/welcome/008-customization-tab.png'
                ]
            },
            "welcome-live": {
                titleKey: 'appWelcomeLiveTitle',
        ...
        boro: {
            ...
            "repo-selector": {
                ...
                images: [
                    ...
                    'images/boro/repo-selector/002-gpg-keys.png',
                    'images/boro/repo-selector/003-speed-test.png',
                    'images/boro/repo-selector/004-info.png'
                ]
            },
            "welcome": {
                titleKey: 'appWelcomeTitle',
                ...
                images: [
                    ...
                    'images/boro/welcome/006-kernels-tab-02.png',
    ...
    document.querySelectorAll('.app-icon-btn').forEach(btn => {
        btn.addEventListener('click', (e) => {
            ...
            if (data) {
                ...
                if (modalTitle) modalTitle.textContent = window.getTranslatedText(data.titleKey);
                if (modalDesc) modalDesc.textContent = window.getTranslatedText(data.descKey);
    ...
    if (menuButton && mobileNav) {
        menuButton.addEventListener('click', (e) => {
            ...
            setTimeout(() => { menuButton.style.background = ''; }, 300);
        });
    ...
    document.addEventListener('click', (e) => {
        if (!e.target.closest('.menu-dropdown') && !e.target.closest('.mobile-menu-toggle')) {
            document.querySelectorAll('.menu-dropdown').forEach(dd => dd.classList.remove('open'));
        }
    });
